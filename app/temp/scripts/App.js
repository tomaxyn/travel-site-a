			...
			value: function createPageSectionWaypoints() {
				...
				this.pageSections.each(function () {
					...
					new Waypoint({
						...
						handler: function handler(direction) {
							if (direction == 'down') var matchingHeaderLink = currentPageSection.getAttribute('data-matching-link');
							heli.headerLinks.removeClass('is-current-link');
					...
					new Waypoint({
						element: currentPageSection,
						handler: function handler(direction) {
							if (direction == 'up') var matchingHeaderLink = currentPageSection.getAttribute('data-matching-link');
							heli.headerLinks.removeClass('is-current-link');
							(0, _jquery2.default)(matchingHeaderLink).addClass('is-current-link');
						},
						offset: '-40%'
